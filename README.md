Project in creation to consolidate and validate back-end development knowledge using Java and Spring Boot, applying architecture, clean code and modern tools.
